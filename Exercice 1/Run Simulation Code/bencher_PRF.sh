...
# Benchmark Execution Script (PRF)
...
# Main directories
HLP_PATH=${ACA_PATH}/advcomparch_ex1     # CSLab Helper code & pintool
PAR_PATH=${ACA_PATH}/parsec-3.0       # Parsec folder
PIN_PATH=${ACA_PATH}/pin-3.13-98189-g60a6ef199-gcc-linux         # PIN folder
