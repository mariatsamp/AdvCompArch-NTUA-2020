...
for bench in "${BenchArray[@]}"; do
    python ~/advcomparch-2020-helpers/TLB/graph_TLB.py "false" ${bench} ${OUT_PATH}/${bench}_TLB*
    mv TLB.png TLB_${bench}.png
done

# Create the graphs for the second question
for bench in "${BenchArray[@]}"; do
    python ~/advcomparch-2020-helpers/TLB/graph_TLB.py "true" "${bench}, IPC Reduction" ${OUT_PATH}/${bench}_TLB*
